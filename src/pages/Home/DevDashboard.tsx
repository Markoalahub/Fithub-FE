          ...
          {features.map((feat, idx) => {
            ...
            return (
              <React.Fragment key={feat.id}>
                <div
                  className={`flex-shrink-0 w-80 p-4 rounded-xl border transition-all flex flex-col h-72 ${
                    status === "completed"
                ...
                >
                  <div className="flex justify-between items-start mb-3">
                    <h4
                      className={`font-medium text-sm truncate ${status === "completed" ? "text-gray-500" : "text-gray-800"}`}
                    >
                      {feat.name}
                    </h4>
                    <button
